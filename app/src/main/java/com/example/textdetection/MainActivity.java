...
import com.example.textdetection.ml.MascotasModel;
...
protected void onActivityResult(int requestCode, int resultCode, Intent data) {
    ...
    try {
        ...
        MascotasModel model = MascotasModel.newInstance(getApplicationContext());
        TensorImage image = TensorImage.fromBitmap(mSelectedImage);

        MascotasModel.Outputs outputs = model.process(image);;
